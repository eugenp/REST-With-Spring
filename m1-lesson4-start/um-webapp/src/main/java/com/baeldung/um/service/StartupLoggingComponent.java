...
public class StartupLoggingComponent implements InitializingBean {
	...
	private void logSpringActiveProfile(final Environment environment) {
		final String springActiveProfile = getValueOfProperty(environment, ACTIVE_SPRING_PROFILE_KEY, "none", null);
		logger.info("{} = {}", ACTIVE_SPRING_PROFILE_KEY, springActiveProfile);
	}
