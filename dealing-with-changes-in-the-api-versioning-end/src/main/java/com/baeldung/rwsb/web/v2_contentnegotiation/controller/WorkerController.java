...
import com.baeldung.rwsb.web.v2_contentnegotiation.dto.WorkerDto.WorkerUpdateValidationData;

import jakarta.validation.Valid;

@RestController(value = "workerController.contentNegotiation.v2")
@RequestMapping(value = "/workers", produces = "application/vnd.rwsb.api.v2+json")
