...
import com.baeldung.rwsb.web.v1_contentnegotiation.dto.WorkerDto.WorkerUpdateValidationData;

import jakarta.validation.Valid;

@RestController(value = "workerController.contentNegotiation.v1")
@RequestMapping(value = "/workers", produces = "application/vnd.rwsb.api.v1+json")
