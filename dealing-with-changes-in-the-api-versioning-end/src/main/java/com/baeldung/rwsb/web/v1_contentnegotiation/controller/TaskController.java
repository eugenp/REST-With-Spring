package com.baeldung.rwsb.web.v1_contentnegotiation.controller;
...
import com.baeldung.rwsb.web.v1_contentnegotiation.dto.WorkerDto;
import com.baeldung.rwsb.web.v1_contentnegotiation.dto.TaskDto.TaskUpdateAssigneeValidationData;
import com.baeldung.rwsb.web.v1_contentnegotiation.dto.TaskDto.TaskUpdateStatusValidationData;
import com.baeldung.rwsb.web.v1_contentnegotiation.dto.TaskDto.TaskUpdateValidationData;

@RestController(value = "taskController.contentNegotiation.v1")
@RequestMapping(value = "/tasks", produces = "application/vnd.rwsb.api.v1+json")
public class TaskController {
    ...
    @PostMapping(consumes = "application/vnd.rwsb.api.v1+json")
    ...
    @PutMapping(value = "/{id}", consumes = "application/vnd.rwsb.api.v1+json")
    ...
    @PutMapping(value = "/{id}/status", consumes = "application/vnd.rwsb.api.v1+json")
    ...
    @PutMapping(value = "/{id}/assignee", consumes = "application/vnd.rwsb.api.v1+json")
