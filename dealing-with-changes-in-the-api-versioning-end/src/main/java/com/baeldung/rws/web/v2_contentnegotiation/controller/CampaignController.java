...
import com.baeldung.rws.web.v2_contentnegotiation.dto.CampaignDto.CampaignUpdateValidationData;

@RestController(value = "campaignController.contentNegotiation.v2")
@RequestMapping(value = "/campaigns", produces = "application/vnd.rws.api.v2+json")
