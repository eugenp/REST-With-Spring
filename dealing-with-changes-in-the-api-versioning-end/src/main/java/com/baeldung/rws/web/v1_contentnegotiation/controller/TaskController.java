package com.baeldung.rws.web.v1_contentnegotiation.controller;
...
import com.baeldung.rws.web.v1_contentnegotiation.dto.TaskDto.TaskUpdateAssigneeValidationData;
import com.baeldung.rws.web.v1_contentnegotiation.dto.TaskDto.TaskUpdateStatusValidationData;
import com.baeldung.rws.web.v1_contentnegotiation.dto.TaskDto.TaskUpdateValidationData;
import com.baeldung.rws.web.v1_contentnegotiation.dto.WorkerDto;

@RestController(value = "taskController.contentNegotiation.v1")
@RequestMapping(value = "/tasks", produces = "application/vnd.rws.api.v1+json")
public class TaskController {
    ...
    @PostMapping(consumes = "application/vnd.rws.api.v1+json")
    ...
    @PutMapping(value = "/{id}", consumes = "application/vnd.rws.api.v1+json")
    ...
    @PutMapping(value = "/{id}/status", consumes = "application/vnd.rws.api.v1+json")
    ...
    @PutMapping(value = "/{id}/assignee", consumes = "application/vnd.rws.api.v1+json")
