...
import com.baeldung.rws.web.v1_contentnegotiation.dto.CampaignDto.CampaignUpdateValidationData;

@RestController(value = "campaignController.contentNegotiation.v1")
@RequestMapping(value = "/campaigns", produces = "application/vnd.rws.api.v1+json")
