...
import com.baeldung.rws.web.v2_contentnegotiation.dto.WorkerDto.WorkerUpdateValidationData;

import jakarta.validation.Valid;

@RestController(value = "workerController.contentNegotiation.v2")
@RequestMapping(value = "/workers", produces = "application/vnd.rws.api.v2+json")
