...
import com.baeldung.rws.web.v1_contentnegotiation.dto.WorkerDto.WorkerUpdateValidationData;

import jakarta.validation.Valid;

@RestController(value = "workerController.contentNegotiation.v1")
@RequestMapping(value = "/workers", produces = "application/vnd.rws.api.v1+json")
