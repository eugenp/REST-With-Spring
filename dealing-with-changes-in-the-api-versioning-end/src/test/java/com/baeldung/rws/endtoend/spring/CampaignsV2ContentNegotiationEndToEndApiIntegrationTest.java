...
import com.baeldung.rws.web.v2_contentnegotiation.dto.CampaignDto;
import com.baeldung.rws.web.v2_contentnegotiation.dto.TaskDto;
...
public class CampaignsV2ContentNegotiationEndToEndApiIntegrationTest {
    ...
    void givenPreloadedData_whenGetSingleCampaign_thenResponseIsEqualToExpectedObject() {
        webClient.get()
            .uri("/campaigns/3")
            .accept(MediaType.valueOf("application/vnd.rws.api.v2+json"))
            .exchange()
            .expectStatus()
            .isOk()
            .expectHeader()
            .contentType("application/vnd.rws.api.v2+json")
    ...
    void whenCreateNewCampaign_thenCreatedAndResponseFieldsMatch() {
        CampaignDto newCampaignBody = new CampaignDto(null, "TEST-E2E-CAMPAIGN-NEW-3CN", "Test - New Campaign 3CN", "Description of new test campaign 3CN", null);

        webClient.post()
            .uri("/campaigns")
            .accept(MediaType.valueOf("application/vnd.rws.api.v2+json"))
            .contentType(MediaType.valueOf("application/vnd.rws.api.v2+json"))
    ...
    void whenCreateNewCampaignWithoutVersionContentTypeHeader_thenUnsupportedMediaType() {
        ...
        webClient.post()
            ...
            .expectHeader()
            .value(HttpHeaders.ACCEPT, acceptHeader -> assertThat(acceptHeader).contains("application/vnd.rws.api.v2+json"));
    }

    @Test
    void whenCreateNewCampaignWithDuplicatedCode_thenBadRequest() {
        CampaignDto newCampaignBody = new CampaignDto(null, "TEST-E2E-CAMPAIGN-NEW-4CN", "Test - New Campaign 3", "Description of new test campaign 3", null);
        ...
        CampaignDto newDuplicatedCodeCampaignBody = new CampaignDto(null, "TEST-E2E-CAMPAIGN-NEW-4CN", "Test - New Campaign 4", "Description of new test campaign 4", null);
    ...
    void givenPreloadedData_whenUpdateExistingCampaign_thenOkWithSupportedFieldUpdated() {
        ...
        CampaignDto updatedCampaignBody = new CampaignDto(null, "TEST-E2E-CAMPAIGN-UPDATED-2CN", "Test - Updated Campaign 2", "Description of updated test campaign 2", tasksListBody);
    ...
    void givenPreloadedData_whenUpdateWithInvalidFields_thenBadRequest() {
        // null name
        CampaignDto nullNameCampaignBody = new CampaignDto(null, "TEST-E2E-CAMPAIGN-UPDATED-4CN", null, "Description of updated test campaign 4CN", null);
