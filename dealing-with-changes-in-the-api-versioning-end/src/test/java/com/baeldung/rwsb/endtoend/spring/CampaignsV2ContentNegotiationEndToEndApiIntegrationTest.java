package com.baeldung.rwsb.endtoend.spring;
...
import com.baeldung.rwsb.web.v2_contentnegotiation.dto.CampaignDto;
...
public class CampaignsV2ContentNegotiationEndToEndApiIntegrationTest {
    ...
    void givenPreloadedData_whenGetSingleCampaign_thenResponseIsEqualToExpectedObject() {
        webClient.get()
            .uri("/campaigns/3")
            .accept(MediaType.valueOf("application/vnd.rwsb.api.v2+json"))
            .exchange()
            .expectStatus()
            .isOk()
            .expectHeader()
            .contentType("application/vnd.rwsb.api.v2+json")
    ...
    void whenCreateNewCampaign_thenCreatedAndResponseFieldsMatch() {
        ...
        webClient.post()
            .uri("/campaigns")
            .accept(MediaType.valueOf("application/vnd.rwsb.api.v2+json"))
            .contentType(MediaType.valueOf("application/vnd.rwsb.api.v2+json"))
    ...
    void whenCreateNewCampaignWithoutVersionContentTypeHeader_thenUnsupportedMediaType() {
        ...
        webClient.post()
            ...
            .expectHeader()
            .value(HttpHeaders.ACCEPT, acceptHeader -> assertThat(acceptHeader).contains("application/vnd.rwsb.api.v2+json"));
    }
