...
public class RwsAppTasksIntegrationTest {
    ...
    void whenPutInvalidTask_then400WithErrorResponseFields() {
        ...
        webClient.put()
            ...
            .isEqualTo(400)
            .jsonPath("$.message")
            .isEqualTo("Invalid associated entity: Unable to find com.baeldung.rws.domain.model.Campaign with id 99")
            .jsonPath("$.exception")
            .exists()
            .jsonPath("$.trace")
            .exists()
    ...
    void whenPutInvalidTask2_then400WithErrorResponseFields() {
        ...
        webClient.put()
            ...
            .isEqualTo(400)
            .jsonPath("$.message")
            .isEqualTo("Invalid associated entity: Unable to find com.baeldung.rws.domain.model.Worker with id 99")
            .jsonPath("$.exception")
            .exists()
            .jsonPath("$.trace")
            .exists()
