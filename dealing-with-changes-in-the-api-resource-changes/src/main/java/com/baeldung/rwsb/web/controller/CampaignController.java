...
public class CampaignController {
    ...
    @GetMapping(value = "/{id}")
    public CampaignDto findOne(@PathVariable String id) {
    ...
    @PutMapping(value = "/{id}")
    public CampaignDto update(@PathVariable String id, @RequestBody @Validated(CampaignUpdateValidationData.class) CampaignDto updatedCampaign) {
