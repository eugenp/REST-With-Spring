...
import org.baeldung.rest.common.client.template.IClient;
import org.baeldung.rest.common.search.ClientOperation;
import org.baeldung.rest.common.util.SearchField;
import org.baeldung.rest.common.util.order.OrderByName;
import org.junit.Ignore;
import org.junit.Test;
import org.springframework.data.domain.Sort;

@SuppressWarnings("unchecked")
public abstract class AbstractLogicClientLiveTest<T extends INameableDto> extends AbstractRawLogicClientLiveTest<T> {
    ...
    @Override
    protected abstract IClient<T> getApi();
