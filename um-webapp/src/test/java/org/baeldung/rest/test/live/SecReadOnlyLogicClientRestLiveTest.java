...
import org.baeldung.rest.common.client.AbstractReadOnlyLogicClientLiveTest;
...
public abstract class SecReadOnlyLogicClientRestLiveTest<T extends INameableDto> extends AbstractReadOnlyLogicClientLiveTest<T> {
