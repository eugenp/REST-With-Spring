...
@ComponentScan({ "org.baeldung.rest.persistence" })
@PropertySource({ "classpath:persistence-${persistenceTarget:mysql}.properties" })
@EnableJpaRepositories(basePackages = "org.baeldung.rest.persistence.dao")
public class PersistenceJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "org.baeldung.rest" });
