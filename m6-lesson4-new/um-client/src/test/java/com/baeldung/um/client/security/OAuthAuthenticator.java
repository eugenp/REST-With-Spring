...
public class OAuthAuthenticator implements ITestAuthenticator {
    ...
    final String getAccessToken(final String username, final String password) {
        try {
            final URI uri = new URI(webProps.getProtocol(), null, webProps.getHost(), webProps.getAuthServerPort(), webProps.getAuthServerPath() + webProps.getOauthPath(), null, null);
