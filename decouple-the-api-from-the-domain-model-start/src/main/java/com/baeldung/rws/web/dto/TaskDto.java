...
public record TaskDto( // @formatter:off
    ...
    public static class Mapper {
        public static Task toModel(TaskDto dto) {
            ...
            Task model = new Task(dto.name(), dto.description(), dto.dueDate(), campaign, dto.status(), NewWorkerDto.Mapper.toModel(dto.assignee()), dto.uuid(), Optional.ofNullable(dto.estimatedHours())
                .orElse(0));
