...
public class RoleController extends AbstractController<Role> {
    ...
    @ResponseBody
    public List<Role> findPaginated(@RequestParam("page") final int page, @RequestParam("size") final int size, @RequestParam(value = "sortBy", required = false) final String sortBy,
