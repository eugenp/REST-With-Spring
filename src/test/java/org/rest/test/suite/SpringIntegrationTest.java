...
@ContextConfiguration(classes = { PersistenceJPAConfig.class, SecurityConfig.class, TestingTestConfig.class, ContextTestConfig.class }, loader = AnnotationConfigContextLoader.class)
