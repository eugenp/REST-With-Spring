...
public final class ParseQueryStringUnitTest{
	...
	public final void givenQueryContainsValidNegatedIdAndPositiveNameConstraint_whenQueryIsParsed_thenResultsAreCorrect(){
		final List< ImmutablePair< String, ? >> parsedQueryString = SearchCommonUtil.parseQueryString( SearchCommonUtil.ID + SearchCommonUtil.NEGATION + SearchCommonUtil.OP + "3" + SearchCommonUtil.SEPARATOR + SearchCommonUtil.NAME + SearchCommonUtil.OP + "some" );
