...
public class RoleSearchRESTIntegrationTest {
	...
	// When
	final List<Role> found = getTemplate().search(IDUtils.randomPositiveLong(), existingResource.getName());
	...
	// When
	final List<Role> found = getTemplate().search(IDUtils.randomPositiveLong(), randomAlphabetic(8));
