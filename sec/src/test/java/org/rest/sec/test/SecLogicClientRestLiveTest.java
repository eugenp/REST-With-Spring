...
import org.rest.common.client.AbstractLogicClientLiveTest;
...
public abstract class SecLogicClientRestLiveTest<T extends INameableEntity> extends AbstractLogicClientLiveTest<T> {
