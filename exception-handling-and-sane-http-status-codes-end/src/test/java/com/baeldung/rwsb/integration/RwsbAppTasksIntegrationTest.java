...
public class RwsbAppTasksIntegrationTest {
    ...
    void whenPutInvalidTask_then400WithErrorResponseFields() {
        ...
        webClient.put()
            ...
            .isEqualTo(400)
            .jsonPath("$.message")
            .isEqualTo("Associated entity not found: Unable to find com.baeldung.rwsb.domain.model.Campaign with id 99")
            .jsonPath("$.exception")
            .exists()
            .jsonPath("$.trace")
            .exists()
    ...
    void whenPutInvalidTask2_then400WithErrorResponseFields() {
        ...
        webClient.put()
            ...
            .isEqualTo(400)
            .jsonPath("$.message")
            .isEqualTo("Associated entity not found: Unable to find com.baeldung.rwsb.domain.model.Worker with id 99")
            .jsonPath("$.exception")
            .exists()
            .jsonPath("$.trace")
            .exists()
